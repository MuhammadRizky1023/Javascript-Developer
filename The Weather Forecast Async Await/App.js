...
const wheaterDetails = document.querySelector(".details");
...
function displayWeathers(weather) {
   ...
   <div class="place">${locationWeather.name}, ${locationWeather.country}</div>
    ...
    wheaterDetails.innerHTML = wheaterEl
}